...
<div class="bf-sorter-groups-container">
    <ul id="bf-sorter-group-<?php echo $options['id']; ?>" class="bf-sorter-list bf-sorter-<?php echo $options['id']; ?>" >
        ...
        foreach( $value as $item_id => $item ) {
            if( ! $item ) continue;
            ?>
            <li id="bf-sorter-group-item-<?php echo $options['id']; ?>-<?php echo $item_id; ?>" class="<?php echo isset( $options['options'][$item_id]['css-class'] ) ? $options['options'][$item_id]['css-class'] : ''; ?> item-<?php echo $item_id; ?> checked-item" style="<?php echo isset( $options['options'][$item_id]['css'] ) ? $options['options'][$item_id]['css'] : ''; ?>">
                <label>
                    <input name="<?php echo $options['input_name']?>[<?php echo $item_id; ?>]" value="1" type="checkbox" checked="checked" />
        ...
        foreach( $options['options'] as $item_id => $item ) {
            ...
            <li id="bf-sorter-group-item-<?php echo $options['id']; ?>-<?php echo $item_id; ?>" class="<?php echo isset( $item['css-class'] ) ? $item['css-class'] : ''; ?> item-<?php echo $item_id; ?>" style="<?php echo isset( $item['css'] ) ? $item['css'] : ''; ?>">
                <label>
                    <input name="<?php echo $options['input_name']?>[<?php echo $item_id; ?>]" value="1" type="checkbox" <?php echo $check_all ? ' checked="checked" ' : ''; ?>/>
        ...
        foreach( $options['options'] as $item_id => $item ) { ?>
            <li id="bf-sorter-group-item-<?php echo $options['id']; ?>-<?php echo $item_id; ?>" class="<?php echo isset( $item['css-class'] ) ? $item['css-class'] : ''; ?> item-<?php echo $item_id; ?>" style="<?php echo isset( $item['css'] ) ? $item['css'] : ''; ?>">
                <label>
                    <input name="<?php echo $options['input_name']?>[<?php echo $item_id; ?>]" value="0" type="checkbox" disabled />
                    <?php echo is_array( $item) ? $item['label'] : $item; ?>
                </label>
            </li>
            <?php
